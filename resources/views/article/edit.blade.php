...
<div class="container">
    <div class="col">
        <div class="row">
            <h3 class="title">Edit Artikel</h3>
        </div>
        <div class="row">
            @if ($errors->any())
            ...
            <form action="{{ route('daftar-artikel.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input id="judul" type="text" class="rounded form-control @error('judul') is-invalid @enderror" name="judul" required autofocus value="{{ $article->judul }}">
                        @error('judul')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea id="artikel" type="text" class="rounded form-control @error('artikel') is-invalid @enderror" name="artikel" required autofocus>{{ $article->artikel }}</textarea>
                        @error('artikel')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
